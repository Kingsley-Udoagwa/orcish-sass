...
`;) r -= 1;
	...
	if (!r) return n;
	let e = r[2];
	return On(n, e, n.lastIndexOf(r[1])) ? n : Cn(n) % 2 === 1 ? $n(n) ? n : `${n}***` : n;
};
var Ln = /<[a-zA-Z/][^>]*$/, x = (n) => {
	let r = n.match(Ln);
...
var Gn = /* @__PURE__ */ new RegExp("(?<=[\\p{L}\\p{N}_])~(?!~)(?=[\\p{L}\\p{N}_])", "gu"), tn = (n) => !n || typeof n != "string" || !n.includes("~") ? n : n.replace(Gn, (r, e) => c(n, e) ? r : "\\~");
var an = (n) => {
	var e, i;
	let r = n.match(K);
	if (r) {
...
var S = (n) => n !== false, Fn = (n) => n === true, u = {
	...
	return Xn.filter(({ handler: i, optionKey: s }) => i.name === "links" ? S(n == null ? void 0 : n.links) || S(n == null ? void 0 : n.images) : i.name === "inlineKatex" ? Fn(n == null ? void 0 : n.inlineKatex) : S(n == null ? void 0 : n[s])).map(({ handler: i, earlyReturn: s }) => i.name === "links" ? {
